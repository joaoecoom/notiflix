...
const BUILTIN_PLATFORMS: PlatformDefinition[] = [
  ...
  },
  {
    ...
    name: 'Utmify',
    kind: 'builtin',
    iconSrc: '/platforms/utmify.svg',
    messageTemplate: 'Nova venda registada — {amount}',
    defaultCurrency: 'BRL',
  ...
  },
  {
    ...
    name: 'Hotmart',
    kind: 'builtin',
    iconSrc: '/platforms/hotmart.svg',
    messageTemplate: 'Você recebeu uma comissão de {amount}',
    defaultCurrency: 'BRL',
    hasMobileDashboard: false,
  },
];
